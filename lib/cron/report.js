...
// ========== CONSTANTS & UTILS (dùng chung nếu cần, nhưng copy vào đây để module độc lập) ==========
...
export default async function handler(req, res) {
    // Lưu ý: CRON_SECRET đã được kiểm tra ở api/cron/[...job].js, không cần kiểm tra lại ở đây
    try {
        const {
            date,
            year,
