...
(function () {
  ...
  // (Dán toàn bộ nội dung file lib/qrcode.min.js vào vị trí này)
  // ============================================================
  // Bạn hãy copy-paste toàn bộ nội dung file lib/qrcode.min.js vào đây,
  // bắt đầu từ dòng dưới đây.
  // var QRCode = function(t) { "use strict"; ... }(this);
  // ============================================================
        ...
        function (err, url) {
          if (err) {
            document.dispatchEvent(
              new CustomEvent("as-qr-generated", {
